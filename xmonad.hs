...
main = do
    xmproc0 <- spawnPipe "xmobar -x 0 ~/.config/xmobar/xmobarrc2" -- xmobar mon 2
    xmproc1 <- spawnPipe "xmobar -x 1 ~/.config/xmobar/xmobarrc1" -- xmobar mon 1
    xmproc2 <- spawnPipe "xmobar -x 2 ~/.config/xmobar/xmobarrc0" -- xmobar mon 0
...
------------------------------------------------------------------------
myStartupHook = do
	  spawnOnce "feh  --image-bg black --bg-center ~/Pictures/fedora01.jpg"
          spawnOnce "konsole &" 
	  spawnOnce "neofetch &"
          ...
          --spawnOnce "~/.xmonad/xmonad.wallpaper" -- Sets our wallpaper
...
myKeys =
    ...
    -- GUI Apps
        , ("M-b", spawn "surf http://www.youtube.com/")
        , ("M-f", spawn "pcmanfm")
